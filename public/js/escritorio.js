    ...
    let html = yo
        ...
        : `
            <li class="animated fadeIn">
                ${mensaje.mesa !== 'Administrador' ? `<div class="chat-img"><img src="https://res.cloudinary.com/dj3akdhb9/image/upload/v1695696885/icons8-circundado-usuario-mujer-tipo-4-de-la-piel-48_ttarml.png" alt="user" /></div>` : ''}
                <div class="chat-content">
                    <h5>${mensaje.mesa}</h5>
...
function scrollBottom() {
    ...
    const lastMessageHeight = (newMessage.previousElementSibling && newMessage.previousElementSibling.clientHeight) || 0;
