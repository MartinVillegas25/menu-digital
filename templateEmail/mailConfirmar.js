const confirmar = `<div class="es-wrapper-color">
<!--[if gte mso 9]>
                                                        ...
                                                        <tr>
                                                            <td width="520" class="esd-container-frame" align="center" valign="top">
                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center" class="esd-block-image es-m-txt-c" style="font-size: 0px;"><a target="_blank" href="https://viewstripo.email"><img src="https://qvepwu.stripocdn.email/content/guids/CABINET_57467d8c432681c379ceb1c7cf73fd9bf612598078b5ac29ee5036ddadf102d3/images/si_mesero_v2_mesa_de_trabajo_6_copia_38_1.png" alt="Confirm email" style="display: block; border-radius: 100px;" width="170" title="Confirm email"></a></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="left" class="esd-block-text es-p20">
                                                                                <h3>Bienvenido a SiMesero</h3>
                                                                                <p><br></p>
                                                                                <p>Hemos recibido tu suscripcion correctamente. Empieza a disfrutar de nuestra plataforma.&nbsp;<br><br><br></p>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center" class="esd-block-button">
                                                                                <!--[if mso]><a href="https://simesero.com" target="_blank" hidden>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://simesero.com" 
        style="height:56px; v-text-anchor:middle; width:520px" arcsize="50%" stroke="f"  fillcolor="#ffa101">
<w:anchorlock></w:anchorlock>
<center style='color:#ffffff; font-family:Imprima, Arial, sans-serif; font-size:22px; font-weight:700; line-height:22px;  mso-text-raise:1px'>IR AL HOME</center>
</v:roundrect></a>
<![endif]-->
                                                                                <!--[if !mso]><!-- --><span class="msohide es-button-border" style="display: block; background: #ffa101;"><a href="https://simesero.com" class="es-button msohide" target="_blank" style="padding-left: 5px; padding-right: 5px; display: block; background: #ffa101; mso-border-alt: 10px solid #ffa101;">IR AL HOME</a></span>
                                                                                <!--<![endif]-->
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="left" class="esd-block-text">
                                                                                <p>Gracias<br><br>Equipo de Si Mesero</p>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" class="esd-block-social es-m-txt-c es-p10t es-p20b" style="font-size:0">
                                                                                <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td align="center" valign="top" esd-tmp-icon-type="twitter" class="es-p5r"><a target="_blank" href><img src="https://qvepwu.stripocdn.email/content/assets/img/social-icons/logo-black/twitter-logo-black.png" alt="Tw" title="Twitter" height="24"></a></td>
                                                                                            <td align="center" valign="top" esd-tmp-icon-type="facebook" class="es-p5r"><a target="_blank" href><img src="https://qvepwu.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" title="Facebook" height="24"></a></td>
                                                                                            <td align="center" valign="top" esd-tmp-icon-type="linkedin"><a target="_blank" href><img src="https://qvepwu.stripocdn.email/content/assets/img/social-icons/logo-black/linkedin-logo-black.png" alt="In" title="Linkedin" height="24"></a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
